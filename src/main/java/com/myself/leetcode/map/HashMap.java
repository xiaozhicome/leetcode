package com.myself.leetcode.map;
...
public class HashMap<K,V> extends AbstractMap<K,V>
    ...
    TreeNode<K,V> newTreeNode(int hash, K key, V value, HashMap.Node<K,V> next) {
        return new TreeNode<>(hash, key, value, next);
    }

    // For treeifyBin
    TreeNode<K,V> replacementTreeNode(HashMap.Node<K,V> p, HashMap.Node<K,V> next) {
